package com.example.lab3databinding
...
import com.example.lab3databinding.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun showAlertBox(context: Context, name: String, email: String, phone: String, password: String, rePassword: String ) {
            ...
            btnSubmit.setOnClickListener {
                showAlertBox( this, edtName.text.toString(),
